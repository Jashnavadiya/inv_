...
function Dashboard() {
  ...
  return (
    <>
      <div className="col-span-10 p-4 gap-2 grid">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
          <article className="flex flex-col lg:col-span-8 col-span-1 rounded-lg border border-gray-100 bg-white p-4">
            <h2>Sales Overview</h2>
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-2">
          ...
          <article className="flex flex-col gap-2 lg:col-span-4 col-span-1 rounded-lg border border-gray-100 bg-white p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
          ...
          <article className="flex flex-col gap-4 lg:col-span-4 col-span-1 rounded-lg border border-gray-100 bg-white p-4">
            <h2>Inventory Management</h2>
