...
const UpdateProduct = ({ isOpen, onClose, updateProductData }) => {
  ...
  const handleUpdate = async () => {
    try {
      console.log(product.productID,product.name,product.manufacturer,product.description);
      console.log(`http://localhost:4000/api/product/update/${product.productID}`);
      
      const response = await fetch(`http://localhost:4000/api/product/update/${product.productID}`, {
        method: "PUT",
        headers: {
